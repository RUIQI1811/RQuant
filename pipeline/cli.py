...
用法：
  ...
  python -m pipeline.cli signal-returns --start 2025-01-01 --end 2025-12-31
  python -m pipeline.cli portfolio-backtest --strategy brick --hold-days 1
  python -m pipeline.cli research-report --signal-dir data/backtest --portfolio-dir data/portfolio_backtest
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--metadata", default="pipeline/stocklist.csv", help="Optional classification CSV")
